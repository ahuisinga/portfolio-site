  ...
  return (
    <div className="space-y-2 text-lg">
      ...
      <p>
        ...
        together. Where&apos;s the fun in writing code if you don&apos;t get to
        share it with someone when it finally works!
      </p>
      <p>
      ...
      <p>
        ...
        a big football fan, but my love for sports goes beyond Bryant Denny
        stadium. I&apos;m particularly passionate about advocating for
        women&apos;s sports and leveling the playing field when it comes to
        media attention. So if there&apos;s a game on, I&apos;m probably hosting
        a watch party.
      </p>
      <p>
        Books are another love — epic fantasy, rom-coms, offbeat memoirs — I
        read it all. I&apos;m always chasing my next great read or swapping
        ...
        least until the yarn ends up in knots. (I really don&apos;t know what is
        worse — debugging or detangling)
      </p>
      <p>
